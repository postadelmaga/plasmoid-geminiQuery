...
1. Download [last release](https://github.com/postadelmaga/plasmoid-AiQuery/releases/latest/download/Ai-Query.plasmoid) and run `kpackagetool6 -t Plasma/Applet -i Ai-Query.plasmoid`
